...
<body>
    <div class="dashboard">
        <aside class="sidebar">
            <div class="logo">
                <img src="" alt="Umurava Logo" width="32">
            </div>
            <nav class="nav-menu">
            ...
            <div class="user-profile">
                <div class="profile-info"><?php echo  $_SESSION['name'];?></div>
            </div>
        </aside>
        ...
        <main class="main-content">
            <header class="header">
                ...
                <div class="profile-menu">
                    <?php $upl="../uploads/" ?>
                    <img src="<?php echo $upl.$_SESSION['profile_img']?>" alt="Profile" width="32" height="32" style="border-radius: 50%;">
                </div>
            </header>

            <h1 style="margin-bottom: 2rem;">Welcome  <?php echo  $_SESSION['name'];?>!</h1>
    ...
    <div class="challenges-grid">
        ...
        <div class="challenge-card">
            <div class="card-header">
                <img src="..\Assets\68747470733a2f2f7777772e63726561746976656974696e737469747574652e636f6d2f696d616765732f636f757273652f636f757273655f313636333035323035362e6a7067.jpg" alt="Course Thumbnail" width="100">
        ...
        <div class="challenge-card">
            <div class="card-header">
                <img src="..\Assets\data-science-analytics-internet-and-technology-concept-concept-photo.jpg" alt="Course Thumbnail" width="100">
                <button class="status-button">Open</button>
            </div>
            <div class="card-content">
        ...
        <div class="challenge-card">
            <div class="card-header">
                <img src="..\Assets\istockphoto-1420039900-612x612.jpg" alt="Course Thumbnail" width="100">
                <button class="status-button">Open</button>
            </div>
            <div class="card-content">
